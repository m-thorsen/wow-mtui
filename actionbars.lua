...
local function SetOptions()
    ...
    TRACK_HEIGHT    = MTUI.db.global.actionbarTrackHeight;
    BTN_SPACING     = MTUI.db.global.actionbarBtnSpacing + 4;
...
local function SetupTrackbars(self, bar, barWidth, isTopBar, isDouble)
...
local function SetupFrames()
    ...
    AB_FRAME:SetScale(MTUI.db.global.actionbarScale);
